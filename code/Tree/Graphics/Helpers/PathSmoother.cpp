...
QPainterPath PathSmoother::generateSmoothCurve(QList<QPointF> points, bool closed, double tension, int numberOfSegments)
{
    QList<double> ps;
    ...
    return PathSmoother::generateSmoothCurve(ps, closed, tension, numberOfSegments);
}

QPainterPath PathSmoother::generateSmoothCurve(QList<double> points, bool closed, double tension, int numberOfSegments)
{
    ...
    // Create a QPainterPath using the coordinates of the smooth curve
    QPainterPath path;
